 ...
 */
const workflows = [
    { step: '01', title: '数据获取', description: '使用AI助手快速获取所需的金融时间序列数据' },
    { step: '02', title: '数据管理', description: '在数据库中查看和管理所有数据集' },
    { step: '03', title: '模型构建', description: '选择合适的模型类型并配置参数进行建模' },
    { step: '04', title: '结果分析', description: '查看详细的分析报告和预测结果' }
];

/**
 * 支持的模型类型
 */
const modelTypes = ['ARMA', 'ARIMA', 'GARCH', 'ARCH', 'VAR', 'VECM'];

export default function Home() {
    return (
        <div className="finance-home min-h-full bg-gradient-to-br from-pink-50 to-rose-50 overflow-auto">
            {/* Hero Section */}
            <section className="relative py-16 px-6 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 via-rose-500/10 to-fuchsia-500/10" />
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <div className="flex items-center justify-center gap-4 flex-wrap">
                            <Link
                                to="/c/new"
                                className="px-8 py-4 bg-pink-600 text-white text-base font-semibold rounded-lg hover:bg-pink-700 flex items-center gap-2 shadow-lg shadow-pink-600/30 transition-colors"
                            >
                            ...
                            <a
                                href="#features"
                                className="px-8 py-4 bg-white text-gray-900 text-base font-semibold rounded-lg hover:bg-gray-50 flex items-center gap-2 border border-gray-200 transition-colors"
                            >
            ...
            <section id="features" className="py-16 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">核心功能模块</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {features.map((feature, index) => (
                            <Link
                                key={index}
                                to={feature.link}
                                className="group bg-white rounded-2xl border border-gray-200 p-8 hover:border-pink-300 hover:shadow-xl transition-all"
                            >
            ...
            <section className="py-16 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">研究工作流程</h2>
                            ...
                            <div key={index} className="relative">
                                ...
                                {index < workflows.length - 1 && (
                                    <div className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 z-10">
                                        <i className="ri-arrow-right-line text-2xl text-pink-600" />
                                    </div>
                                )}
                            </div>
                        ))}
            ...
            <section className="py-16 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">支持的模型类型</h2>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        {modelTypes.map((model, index) => (
                            <div
                                key={index}
                                className="bg-white rounded-xl border border-gray-200 p-6 text-center hover:border-pink-300 hover:shadow-lg transition-all"
                            >
                                <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-gradient-to-br from-pink-500 to-rose-600 mx-auto mb-3">
                                    <i className="ri-function-line text-white text-2xl" />
                                </div>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-br from-pink-600 to-rose-600 rounded-2xl p-12 text-center text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <Link
                                to="/c/new"
                                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-pink-600 text-base font-semibold rounded-lg hover:bg-gray-50 shadow-xl transition-colors"
                            >
                                <i className="ri-rocket-line text-xl" />
                                开始使用平台
                            </Link>
